...
<body>
    ...
    <nav class="navbar navbar-expand-md navbar-light bg-light sticky-top">
        <div class="container-fluid">
            <a class="navbar-brand" href="<?php echo base_url().'home/index';?>"><i class="fa-solid fa-cake-candles"></i>  Melia Cakes </a>
            ...
            <div class="collapse navbar-collapse" id="navbarRes">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="<?php echo base_url().'restaurant/index';?>">Menu</a>
                    </li>
