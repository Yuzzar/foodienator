...
<head>
    ...
    <title>Aplikasi Pemesanan makanan CodeIgniter</title>
    ...
    <div class="container my-3" style="border: 2px outset green;">
        ...
        <div class="invoice mb-3">
            <div class="row mb-3 p-3">
                <div class="col-6">
                    <h3 style="color:purple"><b>Aplikasi Pemesanan makanan</b></h3>
                </div>
                <div class="col-6">
        ...
        <footer class="text-center">
            ...
            <p>Untuk syarat &ketentuan Silakan kunjungi www.website.com</p>
        </footer>
    </div>
